...
namespace DM {
	...
	void CreateIgnoreZVMT() {
		std::ifstream file( ("csgo\\materials\\chams_ignorez.vmt"));
		...
		if (!file.good()) {
			...
			std::ofstream( ("csgo\\materials\\chams_ignorez.vmt")) << str;
		}
	}

	void CreateVisibleWireVMT() {
		std::ifstream file( ("csgo\\materials\\chams_wire.vmt"));
		...
		if (!file.good()) {
			...
			std::ofstream( ("csgo\\materials\\chams_wire.vmt")) << str;
		}
	}
