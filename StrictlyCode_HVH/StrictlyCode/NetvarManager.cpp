...
//------------------------------------------------------------
// Internal methods below. This is where the yaw work is done
//------------------------------------------------------------
unique_ptr<NetvarTable> NetvarManager::InternalLoadTable(NSDK::RecvTable* pRecvTable, uint32_t offset) {
     ...
     for( auto i = 0;  i < pRecvTable->m_nProps; ++i) {
          ...
          if(pProp->m_RecvType == NSDK::SendPropType::DPT_DataTable &&  //If it is a table AND
