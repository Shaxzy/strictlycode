...
bool ImGui::SliderBehavior(const ImRect& frame_bb, ImGuiID id, float* v, float v_min, float v_max, float power, int decimal_precision, ImGuiSliderFlags flags)
{
	...
	window->DrawList->AddCircleFilled(ImVec2(grab_bb.Min.x + 6, grab_bb.Min.y + ((grab_bb.Max.y - grab_bb.Min.y) / 2)), 5, GetColorU32(ImVec4(0.76f, 0.10f, 0.24f, 1.00f)));
	//window->DrawList->AddRectFilled(ImVec2(grab_bb.Min.x, frame_bb.Min.y + 2), ImVec2(grab_bb.Max.x + 14, frame_bb.Min.y + 14), GetColorU32(ImVec4(0.21f, 0.20f, 0.21f, 1.00f)), 3);
